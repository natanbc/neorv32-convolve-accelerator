...
static void sobel_iter_row_first(int32_t* output_row, const uint8_t* curr_row, uint32_t width) {
...
static void sobel_iter_row(int32_t* output_row, const uint8_t* curr_row, uint32_t width) {
...
static void sobel_iter_row_last(int32_t* output_row, const uint8_t* curr_row, uint32_t width) {
    const uint8_t* prev_row = &curr_row[-(int32_t)width];
    accel_shift_pixel(ACCEL_ROW1, *prev_row++);
    accel_shift_pixel(ACCEL_ROW2, *curr_row++);
